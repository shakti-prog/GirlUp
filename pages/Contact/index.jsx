...
export default function ContactFormWithSocialButtons() {
  ...
  const handleSubmit = () => {
    ...
    if (!validate(email)) {
      window.alert("Pls enter a valid email address");
      return;
    }
    if (message.length < 10) {
      window.alert("The story should atleast have 10 characters");
      return;
    }

    window.alert("Your story has been recorded successfully");
    router.push("/");
  };
              ...
              >
                ...
                >
                  <Tooltip
                    ...
                    hasArrow
                  >
                  <Link href="https://www.linkedin.com/company/girlupathena/">  
                    <IconButton
                  ...
                  <Link href="https://www.instagram.com/girlup.athena/?igshid=YmMyMTA2M2Y=">
                    <IconButton
                      aria-label="github"
                      variant="ghost"
                      size="lg"
